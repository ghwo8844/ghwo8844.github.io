...
var _user$project$AFrame_Primitives$light = _elm_lang$html$Html$node('a-light');
				...
				{ctor: '[]'},
				{
					...
					_0: A2(
						_user$project$AFrame_Primitives$assetItem,
						{
							...
							_1: {
								ctor: '::',
								_0: _user$project$AFrame_Primitives_Attributes$src('https://github.com/ghwo8844/ghwo8844.github.io/tree/master/assets/RageTable.obj'),
								_1: {ctor: '[]'}
							}
						},
						{ctor: '[]'}),
